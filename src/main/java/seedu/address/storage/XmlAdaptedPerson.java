...
public class XmlAdaptedPerson {
     ...
     */
    public XmlAdaptedPerson(String name, String phone, String email, String address, String balance, List<XmlAdaptedTag> tagged) {
        this.name = name;
        this.phone = phone;
        this.email = email;
    ...
    public XmlAdaptedPerson(Person source) {
        ...
        balance = Double.toString(source.getMoney().balance);
