...
This is important to the product as it aims to be quick and efficient. Shortcuts for every command (except exit to
 avoid accidents) allows for a quicker and smoother user experience, thus making book-keeping quick and easy.
...
|`*` |user | split a bill evenly among multiple peple |
