...
* *Code contributed*: [https://github.com/CS2103JAN2018-T11-B4/main/blob/master/collated/functional/chenchongsong.md] [https://github.com/CS2103JAN2018-T11-B4/main/blob/master/collated/test/chenchongsong.md] _{give links to collated code files}_
